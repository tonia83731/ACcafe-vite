...
export default function EditModal({onModalClose}){
  return (
    <div className="bg-white-100 w-8/12 min-w-[600px] fixed top-2/4 left-2/4 translate-x-[-50%] translate-y-[-50%] rounded-md shadow-lg">
      ...
      <form action="" className="px-8 py-4">
        ...
        <div className="flex justify-end mt-4">
          <button className="bg-black-20 text-black-60 font-medium rounded px-3 py-1 mb-4 text-xs hover:font-bold hover:drop-shadow-lg tablet:text-sm">
            Cancel
          </button>
          <span className="mx-1"></span>
